		...
		<form method="GET">		
			<table>
				<tr>
					<td>Selecione a Turma:</td>
					<td>
						<select name="turma" style="width:60px" title="Selecione a turma em que será realizado a chamada">
					...
					<td>Selecione o Professor:</td>
					<td>
						<select name="professor" title="Selecione o professor para realizar a chamada">
					...
					<td>Data de Hoje:</td>
					<td>
						<input type="disabled" disabled="disabled" name="data_atual" value="<?php date_default_timezone_set("America/Sao_Paulo"); echo date('d/m/Y'); ?>" style="width:80px">
					</td>
					<td>						
						<input type="submit" name="buscar" value="Buscar" class="input" id="button">
					</td>
